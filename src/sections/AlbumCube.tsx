    ...
    >
        ...
        >
          <Suspense fallback={null}>
            ...
            <spotLight
              ...
              color="#e63946"
            />
            <pointLight position={[0, 0, 5]} intensity={0.5} color="#e63946" />
      ...
      <div className="absolute bottom-12 left-12 z-20">
        <p className="font-mono-custom text-xs text-[#e63946]/60 uppercase tracking-wider mb-2">
          METRIC {String(currentAlbum.id).padStart(2, '0')} / {String(albumCubeConfig.albums.length).padStart(2, '0')}
        </p>
      ...
      <div className="absolute top-12 left-12 w-20 h-px bg-gradient-to-r from-[#e63946]/50 to-transparent" />
      <div className="absolute top-12 left-12 w-px h-20 bg-gradient-to-b from-[#e63946]/50 to-transparent" />
      
      {/* Section label */}
      <div className="absolute top-12 right-12 z-20 text-right">
        <p className="font-mono-custom text-xs text-[#e63946]/60 uppercase tracking-wider">// FOUNDATION</p>
        <p className="font-mono-custom text-xs text-white/40">EXPERIENCE & METRICS</p>
      </div>
    </section>
  );
};
